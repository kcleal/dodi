...
#define __PYX_HAVE__dodi__pairing
#define __PYX_HAVE_API__dodi__pairing
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "pythread.h"
 ...
 * 
 */
typedef __pyx_t_5numpy_float_t __pyx_t_4dodi_7pairing_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'dodi.pairing' */
static float __pyx_f_4dodi_7pairing_erfcc(float); /*proto*/
static float __pyx_f_4dodi_7pairing_normcdf(float, float, float); /*proto*/
static int __pyx_f_4dodi_7pairing_is_proper_pair(float, float, float, float, float, float, float); /*proto*/
static float __pyx_f_4dodi_7pairing_bwa_pair_score(float, float, float, float, float); /*proto*/
static PyObject *__pyx_f_4dodi_7pairing_optimal_path(PyArrayObject *, float, float, float, float, float, float, float, float, float, float, float); /*proto*/
static PyObject *__pyx_f_4dodi_7pairing_process(PyObject *, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_convert_vector_to_py_int(const std::vector<int>  &); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_4dodi_7pairing_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_4dodi_7pairing_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
...
#define __Pyx_MODULE_NAME "dodi.pairing"
extern int __pyx_module_is_main_dodi__pairing;
int __pyx_module_is_main_dodi__pairing = 0;

/* Implementation of 'dodi.pairing' */
...
static PyObject *__pyx_pf_4dodi_7pairing_process(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_rt); /* proto */
...
static float __pyx_f_4dodi_7pairing_erfcc(float __pyx_v_x) {
  float __pyx_v_z;
  float __pyx_v_t;
  float __pyx_v_r;
  float __pyx_v_p1;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("dodi.pairing.erfcc", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static float __pyx_f_4dodi_7pairing_normcdf(float __pyx_v_x, float __pyx_v_mu, float __pyx_v_sigma) {
  float __pyx_v_t;
  float __pyx_v_y;
  float __pyx_r;
  __Pyx_RefNannyDeclarations
 ...
 */
  ...
  __pyx_v_y = (0.5 * __pyx_f_4dodi_7pairing_erfcc((((double)__pyx_t_1) / __pyx_t_2)));
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("dodi.pairing.normcdf", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static int __pyx_f_4dodi_7pairing_is_proper_pair(float __pyx_v_d, float __pyx_v_pos1, float __pyx_v_pos2, float __pyx_v_strand1, float __pyx_v_strand2, float __pyx_v_mu, float __pyx_v_sigma) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
...
static float __pyx_f_4dodi_7pairing_bwa_pair_score(float __pyx_v_d, float __pyx_v_mu, float __pyx_v_sigma, float __pyx_v_match_score, float __pyx_v_u) {
  float __pyx_v_prob;
  float __pyx_v_c;
  float __pyx_r;
  __Pyx_RefNannyDeclarations
 ...
 *     if c < u:
 */
  __pyx_v_prob = (1.0 - __pyx_f_4dodi_7pairing_normcdf(__pyx_v_d, __pyx_v_mu, __pyx_v_sigma));
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("dodi.pairing.bwa_pair_score", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyObject *__pyx_f_4dodi_7pairing_optimal_path(PyArrayObject *__pyx_v_segments, float __pyx_v_contig_length, float __pyx_v_mu, float __pyx_v_sigma, float __pyx_v_max_insertion, float __pyx_v_min_aln, float __pyx_v_max_homology, float __pyx_v_ins_cost, float __pyx_v_hom_cost, float __pyx_v_inter_cost, float __pyx_v_U, float __pyx_v_match_score) {
  ...
  int __pyx_t_25;
  std::vector<int> ::size_type __pyx_t_26;
  ...
  __pyx_pybuffernd_segments.rcbuffer = &__pyx_pybuffer_segments;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_segments.rcbuffer->pybuffer, (PyObject*)__pyx_v_segments, &__Pyx_TypeInfo_nn___pyx_t_4dodi_7pairing_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 83, __pyx_L1_error)
  }
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_node_scores.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_node_scores.diminfo[0].strides) = ((*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_13, __pyx_pybuffernd_segments.diminfo[1].strides)) - ((*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[1].strides)) * __pyx_v_ins_cost));
  }

  /* "dodi/pairing.pyx":134
 *         node_scores[i] = segments[i, 4] - (segments[i, 2] * ins_cost)
 * 
 *     pred.fill(-1)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_t_14 = 0;
    __pyx_v_chr1 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dodi/pairing.pyx":145
 *     for i in range(1, segments.shape[0]):
 *         chr1 = segments[i, 0]
 *         pos1 = segments[i, 1]             # <<<<<<<<<<<<<<
 *         start1 = segments[i, 2]
 ...
 */
    __pyx_t_14 = __pyx_v_i;
    __pyx_t_15 = 1;
    __pyx_v_pos1 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dodi/pairing.pyx":146
 *         chr1 = segments[i, 0]
 *         pos1 = segments[i, 1]
 *         start1 = segments[i, 2]             # <<<<<<<<<<<<<<
 *         end1 = segments[i, 3]
 ...
 */
    __pyx_t_15 = __pyx_v_i;
    __pyx_t_14 = 2;
    __pyx_v_start1 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dodi/pairing.pyx":147
 *         pos1 = segments[i, 1]
 *         start1 = segments[i, 2]
 *         end1 = segments[i, 3]             # <<<<<<<<<<<<<<
 *         score1 = segments[i, 4]
 ...
 */
    __pyx_t_14 = __pyx_v_i;
    __pyx_t_15 = 3;
    __pyx_v_end1 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dodi/pairing.pyx":148
 *         start1 = segments[i, 2]
 *         end1 = segments[i, 3]
 *         score1 = segments[i, 4]             # <<<<<<<<<<<<<<
 *         row_index1 = segments[i, 5]
 ...
 */
    __pyx_t_15 = __pyx_v_i;
    __pyx_t_14 = 4;
    __pyx_v_score1 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dodi/pairing.pyx":149
 *         end1 = segments[i, 3]
 *         score1 = segments[i, 4]
 *         row_index1 = segments[i, 5]             # <<<<<<<<<<<<<<
 *         strand1 = segments[i, 6]
 ...
 */
    __pyx_t_14 = __pyx_v_i;
    __pyx_t_15 = 5;
    __pyx_v_row_index1 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dodi/pairing.pyx":150
 *         score1 = segments[i, 4]
 *         row_index1 = segments[i, 5]
 *         strand1 = segments[i, 6]             # <<<<<<<<<<<<<<
 *         r1 = segments[i, 7]
 ...
 */
    __pyx_t_15 = __pyx_v_i;
    __pyx_t_14 = 6;
    __pyx_v_strand1 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dodi/pairing.pyx":151
 *         row_index1 = segments[i, 5]
 *         strand1 = segments[i, 6]
 *         r1 = segments[i, 7]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_14 = __pyx_v_i;
    __pyx_t_15 = 7;
    __pyx_v_r1 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dodi/pairing.pyx":153
 *         r1 = segments[i, 7]
 * 
 *         p = -1  # -1 means there is no predecessor             # <<<<<<<<<<<<<<
 ...
 *             chr2 = segments[j, 0]
 */
    for (__pyx_t_17 = (__pyx_v_i - 1); __pyx_t_17 > -1; __pyx_t_17-=1) {
      __pyx_v_j = __pyx_t_17;

      /* "dodi/pairing.pyx":160
 *         for j in range(i-1, -1, -1):
 * 
 *             chr2 = segments[j, 0]             # <<<<<<<<<<<<<<
 *             pos2 = segments[j, 1]
 ...
 */
      ...
      __pyx_t_14 = 0;
      __pyx_v_chr2 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dodi/pairing.pyx":161
 * 
 *             chr2 = segments[j, 0]
 *             pos2 = segments[j, 1]             # <<<<<<<<<<<<<<
 *             start2 = segments[j, 2]
 ...
 */
      ...
      __pyx_t_15 = 1;
      __pyx_v_pos2 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dodi/pairing.pyx":162
 *             chr2 = segments[j, 0]
 *             pos2 = segments[j, 1]
 *             start2 = segments[j, 2]             # <<<<<<<<<<<<<<
 *             end2 = segments[j, 3]
 ...
 */
      __pyx_t_15 = __pyx_v_j;
      __pyx_t_14 = 2;
      __pyx_v_start2 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dodi/pairing.pyx":163
 *             pos2 = segments[j, 1]
 *             start2 = segments[j, 2]
 *             end2 = segments[j, 3]             # <<<<<<<<<<<<<<
 *             score2 = segments[j, 4]
 ...
 */
      __pyx_t_14 = __pyx_v_j;
      __pyx_t_15 = 3;
      __pyx_v_end2 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dodi/pairing.pyx":164
 *             start2 = segments[j, 2]
 *             end2 = segments[j, 3]
 *             score2 = segments[j, 4]             # <<<<<<<<<<<<<<
 *             row_index2 = segments[j, 5]
 ...
 */
      __pyx_t_15 = __pyx_v_j;
      __pyx_t_14 = 4;
      __pyx_v_score2 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dodi/pairing.pyx":165
 *             end2 = segments[j, 3]
 *             score2 = segments[j, 4]
 *             row_index2 = segments[j, 5]             # <<<<<<<<<<<<<<
 *             strand2 = segments[j, 6]
 ...
 */
      __pyx_t_14 = __pyx_v_j;
      __pyx_t_15 = 5;
      __pyx_v_row_index2 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dodi/pairing.pyx":166
 *             score2 = segments[j, 4]
 *             row_index2 = segments[j, 5]
 *             strand2 = segments[j, 6]             # <<<<<<<<<<<<<<
 *             r2 = segments[j, 7]
 ...
 */
      __pyx_t_15 = __pyx_v_j;
      __pyx_t_14 = 6;
      __pyx_v_strand2 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dodi/pairing.pyx":167
 *             row_index2 = segments[j, 5]
 *             strand2 = segments[j, 6]
 *             r2 = segments[j, 7]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_14 = __pyx_v_j;
      __pyx_t_15 = 7;
      __pyx_v_r2 = (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dodi/pairing.pyx":170
 * 
 *             # Allow alignments with minimum sequence and max overlap
 ...
 */
      __pyx_t_19 = ((__pyx_v_start1 > (__pyx_v_end2 - __pyx_v_max_homology)) != 0);
      if (__pyx_t_19) {
      } else {
        __pyx_t_18 = __pyx_t_19;
        goto __pyx_L10_bool_binop_done;
      }
      __pyx_t_19 = ((__pyx_v_end1 > (__pyx_v_end2 + __pyx_v_min_aln)) != 0);
      if (__pyx_t_19) {
      } else {
        __pyx_t_18 = __pyx_t_19;
        goto __pyx_L10_bool_binop_done;
      }
      __pyx_t_19 = (((__pyx_v_start1 - __pyx_v_start2) > __pyx_v_min_aln) != 0);
      __pyx_t_18 = __pyx_t_19;
      __pyx_L10_bool_binop_done:;
      if (__pyx_t_18) {

        /* "dodi/pairing.pyx":172
 *             if start1 > end2 - max_homology and end1 > end2 + min_aln and start1 - start2 > min_aln:
 * 
 *                 if start1 > end2 and start1 - end2 > max_insertion:             # <<<<<<<<<<<<<<
 *                     continue
 * 
 */
        __pyx_t_19 = ((__pyx_v_start1 > __pyx_v_end2) != 0);
        if (__pyx_t_19) {
        } else {
          __pyx_t_18 = __pyx_t_19;
          goto __pyx_L14_bool_binop_done;
        }
        __pyx_t_19 = (((__pyx_v_start1 - __pyx_v_end2) > __pyx_v_max_insertion) != 0);
        __pyx_t_18 = __pyx_t_19;
        __pyx_L14_bool_binop_done:;
        if (__pyx_t_18) {

          /* "dodi/pairing.pyx":173
 * 
 *                 if start1 > end2 and start1 - end2 > max_insertion:
 *                     continue             # <<<<<<<<<<<<<<
 * 
 ...
 *                     micro_h = 0
 */
        __pyx_t_18 = ((__pyx_v_micro_h < 0.0) != 0);
        if (__pyx_t_18) {

          /* "dodi/pairing.pyx":181
 *                 micro_h = end2 - start1
 *                 if micro_h < 0:
 *                     ins = fabs(micro_h)             # <<<<<<<<<<<<<<
 *                     micro_h = 0
 ...
 *                         jump_cost = U
 */
        __pyx_t_18 = ((__pyx_v_chr1 == __pyx_v_chr2) != 0);
        if (__pyx_t_18) {

          /* "dodi/pairing.pyx":187
 *                 proper_pair = 0
 *                 if chr1 == chr2:
 *                     if r1 == r2:  # If the jump occurs on the same read, means there is an SV             # <<<<<<<<<<<<<<
 *                         jump_cost = U
 * 
 */
          __pyx_t_18 = ((__pyx_v_r1 == __pyx_v_r2) != 0);
          if (__pyx_t_18) {

            /* "dodi/pairing.pyx":188
 *                 if chr1 == chr2:
 *                     if r1 == r2:  # If the jump occurs on the same read, means there is an SV
 *                         jump_cost = U             # <<<<<<<<<<<<<<
 * 
 ...
 */
            __pyx_v_proper_pair = __pyx_f_4dodi_7pairing_is_proper_pair(__pyx_v_distance, __pyx_v_pos1, __pyx_v_pos2, __pyx_v_strand1, __pyx_v_strand2, __pyx_v_mu, __pyx_v_sigma);

            /* "dodi/pairing.pyx":193
 *                         distance = fabs(pos1 - pos2)
 *                         proper_pair = is_proper_pair(distance, pos1, pos2, strand1, strand2, mu, sigma)
 *                         if proper_pair:             # <<<<<<<<<<<<<<
 *                             jump_cost = bwa_pair_score(distance, mu, sigma, match_score, U)
 * 
 */
            __pyx_t_18 = (__pyx_v_proper_pair != 0);
            if (__pyx_t_18) {

              /* "dodi/pairing.pyx":194
 *                         proper_pair = is_proper_pair(distance, pos1, pos2, strand1, strand2, mu, sigma)
 *                         if proper_pair:
 *                             jump_cost = bwa_pair_score(distance, mu, sigma, match_score, U)             # <<<<<<<<<<<<<<
 * 
 ...
 */
              __pyx_v_jump_cost = __pyx_f_4dodi_7pairing_bwa_pair_score(__pyx_v_distance, __pyx_v_mu, __pyx_v_sigma, __pyx_v_match_score, __pyx_v_U);

              /* "dodi/pairing.pyx":196
 *                             jump_cost = bwa_pair_score(distance, mu, sigma, match_score, U)
 * 
 *                             normal_jumps.add((i, j))  # Keep track of normal pairings on the path             # <<<<<<<<<<<<<<
 *                         else:
 ...
 */
              ...
              __pyx_t_2 = 0;
              __pyx_t_4 = 0;
              __pyx_t_20 = PySet_Add(__pyx_v_normal_jumps, __pyx_t_3); if (unlikely(__pyx_t_20 == ((int)-1))) __PYX_ERR(0, 196, __pyx_L1_error)
              __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
        __pyx_t_15 = __pyx_v_j;
        __pyx_v_current_score = ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_node_scores.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_node_scores.diminfo[0].strides)) + __pyx_v_S);

        /* "dodi/pairing.pyx":210
 * 
 *                 # Update best score and next best score
 ...
 */
        __pyx_t_18 = ((__pyx_v_current_score > __pyx_v_best_score) != 0);
        if (__pyx_t_18) {

          /* "dodi/pairing.pyx":211
 *                 # Update best score and next best score
 *                 if current_score > best_score:
 *                     next_best_score = best_score             # <<<<<<<<<<<<<<
 *                     best_score = current_score
 ...
 * 
 */
        __pyx_t_18 = ((__pyx_v_current_score > __pyx_v_next_best_score) != 0);
        if (__pyx_t_18) {

          /* "dodi/pairing.pyx":217
 * 
 *                 elif current_score > next_best_score:
 *                     next_best_score = current_score             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_t_18 = ((__pyx_v_current_score > __pyx_v_best_normal_orientation) != 0);
          if (__pyx_t_18) {

            /* "dodi/pairing.pyx":221
 *                 if proper_pair:
 *                     if current_score > best_normal_orientation:
 *                         best_normal_orientation = current_score             # <<<<<<<<<<<<<<
 *                         normal_end_index = i  # index i is towards the right-hand side of the array
 ...
 */
    __pyx_t_15 = __pyx_v_i;
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_node_scores.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_node_scores.diminfo[0].strides) = __pyx_v_best_score;

    /* "dodi/pairing.pyx":225
 * 
 *         node_scores[i] = best_score
 *         pred[i] = p             # <<<<<<<<<<<<<<
 *         nb_node_scores[i] = next_best_score
 ...
 */
    __pyx_t_14 = __pyx_v_i;
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pred.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_pred.diminfo[0].strides) = __pyx_v_p;

    /* "dodi/pairing.pyx":226
 *         node_scores[i] = best_score
 *         pred[i] = p
 *         nb_node_scores[i] = next_best_score             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_nb_node_scores.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_nb_node_scores.diminfo[0].strides) = __pyx_v_next_best_score;
  }

  /* "dodi/pairing.pyx":232
 ...
 */
    ...
    __pyx_t_22 = 3;
    __pyx_v_node_to_end_cost = ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_node_scores.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_node_scores.diminfo[0].strides)) - (__pyx_v_ins_cost * (__pyx_v_contig_length - (*__Pyx_BufPtrStrided2d(__pyx_t_4dodi_7pairing_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_segments.diminfo[1].strides)))));

    /* "dodi/pairing.pyx":240
 * 
 *         node_to_end_cost = node_scores[i] - (ins_cost * (contig_length - segments[i, 3]))
 *         node_scores[i] = node_to_end_cost  # Need to know for secondary path             # <<<<<<<<<<<<<<
 *         if node_to_end_cost > path_score:
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_node_scores.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_node_scores.diminfo[0].strides) = __pyx_v_node_to_end_cost;

    /* "dodi/pairing.pyx":241
 *         node_to_end_cost = node_scores[i] - (ins_cost * (contig_length - segments[i, 3]))
 *         node_scores[i] = node_to_end_cost  # Need to know for secondary path
 *         if node_to_end_cost > path_score:             # <<<<<<<<<<<<<<
 *             path_score = node_to_end_cost
 *             end_i = i
 */
    __pyx_t_18 = ((__pyx_v_node_to_end_cost > __pyx_v_path_score) != 0);
    if (__pyx_t_18) {

      /* "dodi/pairing.pyx":242
 *         node_scores[i] = node_to_end_cost  # Need to know for secondary path
 *         if node_to_end_cost > path_score:
 *             path_score = node_to_end_cost             # <<<<<<<<<<<<<<
 *             end_i = i
 ...
 * 
 */
    __pyx_t_18 = ((__pyx_v_node_to_end_cost > __pyx_v_secondary) != 0);
    if (__pyx_t_18) {

      /* "dodi/pairing.pyx":245
 *             end_i = i
 *         elif node_to_end_cost > secondary:
 *             secondary = node_to_end_cost             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
    __pyx_t_18 = ((__pyx_v_i == __pyx_v_normal_end_index) != 0);
    if (__pyx_t_18) {

      /* "dodi/pairing.pyx":248
 * 
 *         if i == normal_end_index:  # Update the best normal score, deals with right-hand-side soft-clips
 *             best_normal_orientation = node_to_end_cost             # <<<<<<<<<<<<<<
 * 
 ...
 *         v.push_back(end_i)
 */
  __pyx_t_18 = ((__pyx_v_end_i != -1L) != 0);
  if (__pyx_t_18) {

    /* "dodi/pairing.pyx":263
 *     if end_i != -1:
 * 
 *         v.push_back(end_i)             # <<<<<<<<<<<<<<
 *         while True:
 ...
 *                 break
 */
      __pyx_t_21 = __pyx_v_last_i;
      __pyx_v_next_i = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pred.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_pred.diminfo[0].strides));

      /* "dodi/pairing.pyx":267
 *             last_i = v.back()
 *             next_i = pred[last_i]
 *             if next_i == -1:             # <<<<<<<<<<<<<<
 *                 break
 *             v.push_back(next_i)
 */
      __pyx_t_18 = ((__pyx_v_next_i == -1L) != 0);
      if (__pyx_t_18) {

        /* "dodi/pairing.pyx":268
 *             next_i = pred[last_i]
 *             if next_i == -1:
 *                 break             # <<<<<<<<<<<<<<
 *             v.push_back(next_i)
 ...
 */
      ...
      __pyx_t_3 = 0;
      __pyx_t_4 = 0;
      __pyx_t_18 = (__Pyx_PySet_ContainsTF(__pyx_t_2, __pyx_v_normal_jumps, Py_EQ)); if (unlikely(__pyx_t_18 < 0)) __PYX_ERR(0, 271, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_19 = (__pyx_t_18 != 0);
      if (__pyx_t_19) {

        /* "dodi/pairing.pyx":272
 * 
 *             if (last_i, next_i) in normal_jumps:
 *                 normal_pairings += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_21 = __pyx_v_next_i;
      __pyx_v_s = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_nb_node_scores.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_nb_node_scores.diminfo[0].strides));

      /* "dodi/pairing.pyx":275
 * 
 *             s = nb_node_scores[next_i]
 *             dis_2_end = path_score - node_scores[next_i]  # Distance of main path to the end             # <<<<<<<<<<<<<<
 *             potential_secondary = dis_2_end + s
 ...
 */
      __pyx_t_21 = __pyx_v_next_i;
      __pyx_v_dis_2_end = (__pyx_v_path_score - (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_node_scores.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_node_scores.diminfo[0].strides)));

      /* "dodi/pairing.pyx":276
 *             s = nb_node_scores[next_i]
 *             dis_2_end = path_score - node_scores[next_i]  # Distance of main path to the end
 *             potential_secondary = dis_2_end + s             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
      __pyx_t_19 = ((__pyx_v_potential_secondary > __pyx_v_secondary) != 0);
      if (__pyx_t_19) {

        /* "dodi/pairing.pyx":279
 * 
 *             if potential_secondary > secondary:
 *                 secondary = potential_secondary             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_23 = PyObject_Length(__pyx_t_2); if (unlikely(__pyx_t_23 == ((Py_ssize_t)-1))) __PYX_ERR(0, 281, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_t_23); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 281, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_a.rcbuffer->pybuffer, (PyObject*)__pyx_t_24, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
 ...
 *     if secondary < 0:
 */
    __pyx_t_26 = ((__pyx_v_v.size() - 1) - __pyx_v_i);
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_a.rcbuffer->pybuffer.buf, __pyx_t_26, __pyx_pybuffernd_a.diminfo[0].strides) = (__pyx_v_v[__pyx_v_i]);
  }

  /* "dodi/pairing.pyx":285
 *         a[v.size() - 1 - i] = v[i]  # Virtual reversal of the indexes array
 * 
 *     if secondary < 0:             # <<<<<<<<<<<<<<
 *         secondary = 0
 *     if path_score < 0:
 */
  __pyx_t_19 = ((__pyx_v_secondary < 0.0) != 0);
  if (__pyx_t_19) {

    /* "dodi/pairing.pyx":286
 * 
 *     if secondary < 0:
 *         secondary = 0             # <<<<<<<<<<<<<<
 *     if path_score < 0:
 ...
 */
  __pyx_t_19 = ((__pyx_v_path_score < 0.0) != 0);
  if (__pyx_t_19) {

    /* "dodi/pairing.pyx":288
 *         secondary = 0
 *     if path_score < 0:
 *         path_score = 0             # <<<<<<<<<<<<<<
 *     if best_normal_orientation < 0:
 ...
 */
  __pyx_t_19 = ((__pyx_v_best_normal_orientation < 0.0) != 0);
  if (__pyx_t_19) {

    /* "dodi/pairing.pyx":290
 *         path_score = 0
 *     if best_normal_orientation < 0:
 *         best_normal_orientation = 0             # <<<<<<<<<<<<<<
 *     # Return the index column
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_27 = PyTuple_New(5); if (unlikely(!__pyx_t_27)) __PYX_ERR(0, 292, __pyx_L1_error)
  ...
  __Pyx_GIVEREF(__pyx_t_4);
  PyTuple_SET_ITEM(__pyx_t_27, 3, __pyx_t_4);
  __Pyx_GIVEREF(__pyx_t_5);
  PyTuple_SET_ITEM(__pyx_t_27, 4, __pyx_t_5);
  __pyx_t_2 = 0;
  __pyx_t_1 = 0;
  __pyx_t_3 = 0;
  __pyx_t_4 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("dodi.pairing.optimal_path", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_a.rcbuffer->pybuffer);
...
static PyObject *__pyx_pw_4dodi_7pairing_1process(PyObject *__pyx_self, PyObject *__pyx_v_rt); /*proto*/
static PyObject *__pyx_f_4dodi_7pairing_process(PyObject *__pyx_v_rt, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 */
  ...
  __pyx_t_10 = ((PyArrayObject *)__pyx_t_2);
  {
    ...
    __pyx_t_11 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_t.rcbuffer->pybuffer, (PyObject*)__pyx_t_10, &__Pyx_TypeInfo_nn___pyx_t_4dodi_7pairing_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
    if (unlikely(__pyx_t_11 < 0)) {
      PyErr_Fetch(&__pyx_t_12, &__pyx_t_13, &__pyx_t_14);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_t.rcbuffer->pybuffer, (PyObject*)__pyx_v_t, &__Pyx_TypeInfo_nn___pyx_t_4dodi_7pairing_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
 ...
 *     else:
 */
    __pyx_t_7 = __pyx_f_4dodi_7pairing_optimal_path(((PyArrayObject *)__pyx_v_t), __pyx_v_contig_l, __pyx_v_mu, __pyx_v_sigma, __pyx_v_max_insertion, __pyx_v_min_aln, __pyx_v_max_homology, __pyx_v_ins_cost, __pyx_v_hom_cost, __pyx_v_inter_cost, __pyx_v_U, __pyx_v_match_score); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 332, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_r = ((PyObject*)__pyx_t_7);
    __pyx_t_7 = 0;
    goto __pyx_L0;
 ...
 */
      ...
      __pyx_t_10 = ((PyArrayObject *)__pyx_t_1);
      {
        ...
        __pyx_t_11 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_read1_arr.rcbuffer->pybuffer, (PyObject*)__pyx_t_10, &__Pyx_TypeInfo_nn___pyx_t_4dodi_7pairing_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
        if (unlikely(__pyx_t_11 < 0)) {
          PyErr_Fetch(&__pyx_t_14, &__pyx_t_13, &__pyx_t_12);
          if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_read1_arr.rcbuffer->pybuffer, (PyObject*)__pyx_v_read1_arr, &__Pyx_TypeInfo_nn___pyx_t_4dodi_7pairing_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
 ...
 */
      __pyx_t_1 = __pyx_f_4dodi_7pairing_optimal_path(((PyArrayObject *)__pyx_v_read1_arr), __pyx_v_contig_l, __pyx_v_mu, __pyx_v_sigma, __pyx_v_max_insertion, __pyx_v_min_aln, __pyx_v_max_homology, __pyx_v_ins_cost, __pyx_v_hom_cost, __pyx_v_inter_cost, __pyx_v_U, __pyx_v_match_score); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 346, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
 ...
 */
      ...
      __pyx_t_10 = ((PyArrayObject *)__pyx_t_1);
      {
        ...
        __pyx_t_11 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_read2_arr.rcbuffer->pybuffer, (PyObject*)__pyx_t_10, &__Pyx_TypeInfo_nn___pyx_t_4dodi_7pairing_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
        if (unlikely(__pyx_t_11 < 0)) {
          PyErr_Fetch(&__pyx_t_12, &__pyx_t_13, &__pyx_t_14);
          if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_read2_arr.rcbuffer->pybuffer, (PyObject*)__pyx_v_read2_arr, &__Pyx_TypeInfo_nn___pyx_t_4dodi_7pairing_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
            Py_XDECREF(__pyx_t_12); Py_XDECREF(__pyx_t_13); Py_XDECREF(__pyx_t_14);
            __Pyx_RaiseBufferFallbackError();
          } else {
            PyErr_Restore(__pyx_t_12, __pyx_t_13, __pyx_t_14);
 ...
 *                                                                                           max_homology, ins_cost,
 */
      __pyx_t_1 = __pyx_f_4dodi_7pairing_optimal_path(((PyArrayObject *)__pyx_v_read2_arr), __pyx_v_contig_l, __pyx_v_mu, __pyx_v_sigma, __pyx_v_max_insertion, __pyx_v_min_aln, __pyx_v_max_homology, __pyx_v_ins_cost, __pyx_v_hom_cost, __pyx_v_inter_cost, __pyx_v_U, __pyx_v_match_score); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 363, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      if (likely(__pyx_t_1 != Py_None)) {
        PyObject* sequence = __pyx_t_1;
        Py_ssize_t size = __Pyx_PySequence_SIZE(sequence);
 ...
 *                                                                                               max_homology, ins_cost,
 */
      __pyx_t_1 = __pyx_f_4dodi_7pairing_optimal_path(((PyArrayObject *)__pyx_v_t), __pyx_v_contig_l, __pyx_v_mu, __pyx_v_sigma, __pyx_v_max_insertion, __pyx_v_min_aln, __pyx_v_max_homology, __pyx_v_ins_cost, __pyx_v_hom_cost, __pyx_v_inter_cost, __pyx_v_U, __pyx_v_match_score); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 377, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      if (likely(__pyx_t_1 != Py_None)) {
        PyObject* sequence = __pyx_t_1;
        Py_ssize_t size = __Pyx_PySequence_SIZE(sequence);
 ...
 */
      ...
      __pyx_t_10 = ((PyArrayObject *)__pyx_t_7);
      {
        ...
        __pyx_t_11 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_t2.rcbuffer->pybuffer, (PyObject*)__pyx_t_10, &__Pyx_TypeInfo_nn___pyx_t_4dodi_7pairing_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
        if (unlikely(__pyx_t_11 < 0)) {
          PyErr_Fetch(&__pyx_t_14, &__pyx_t_13, &__pyx_t_12);
          if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_t2.rcbuffer->pybuffer, (PyObject*)__pyx_v_t2, &__Pyx_TypeInfo_nn___pyx_t_4dodi_7pairing_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
            Py_XDECREF(__pyx_t_14); Py_XDECREF(__pyx_t_13); Py_XDECREF(__pyx_t_12);
            __Pyx_RaiseBufferFallbackError();
          } else {
            PyErr_Restore(__pyx_t_14, __pyx_t_13, __pyx_t_12);
 ...
 *                                                                                               max_homology, ins_cost,
 */
      __pyx_t_7 = __pyx_f_4dodi_7pairing_optimal_path(((PyArrayObject *)__pyx_v_t2), __pyx_v_contig_l, __pyx_v_mu, __pyx_v_sigma, __pyx_v_max_insertion, __pyx_v_min_aln, __pyx_v_max_homology, __pyx_v_ins_cost, __pyx_v_hom_cost, __pyx_v_inter_cost, __pyx_v_U, __pyx_v_match_score); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 393, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_t2.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("dodi.pairing.process", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_read1_arr.rcbuffer->pybuffer);
...
static PyObject *__pyx_pw_4dodi_7pairing_1process(PyObject *__pyx_self, PyObject *__pyx_v_rt) {
  ...
  __pyx_r = __pyx_pf_4dodi_7pairing_process(__pyx_self, ((PyObject*)__pyx_v_rt));
...
static PyObject *__pyx_pf_4dodi_7pairing_process(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_rt) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("process", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4dodi_7pairing_process(__pyx_v_rt, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 295, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"process", (PyCFunction)__pyx_pw_4dodi_7pairing_1process, METH_O, __pyx_doc_4dodi_7pairing_process},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_dodi__pairing) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dodi.pairing")) {
      if (unlikely(PyDict_SetItemString(modules, "dodi.pairing", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init dodi.pairing", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init dodi.pairing");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
